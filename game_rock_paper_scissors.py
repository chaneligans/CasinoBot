    ...
    if await currency.bet_is_enough(member_id, bet_amount, server_id):
        ...
        if casino_shot == 1:
            ...
            if shot == 'rock':
                ...
                await currency.update_currency(member_id, bet_amount * 3, server_id)
                status = 'You won **{0} gold**! :tada: :tada: :moneybag: New Balance: **{1} gold**!'.format(bet_amount * 3, await currency.get_currency_amount(member_id, server_id))
            elif shot == 'scissors':
